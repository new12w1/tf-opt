...
#ifndef LEARNING_BRAIN_RESEARCH_TF_OPT_SHARED_OPS_RESHAPE_OPERATION_H_
#define LEARNING_BRAIN_RESEARCH_TF_OPT_SHARED_OPS_RESHAPE_OPERATION_H_
...
#endif  // LEARNING_BRAIN_RESEARCH_TF_OPT_SHARED_OPS_RESHAPE_OPERATION_H_
